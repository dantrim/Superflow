...
*/
    ...
    *cutflow << NewSystematic("shift in electron fraction determination"); {
        *cutflow << WeightSystematic(SupersysWeight::ELFRACUP, SupersysWeight::ELFRACDOWN);
        *cutflow << TreeName("ELFRAC");
        *cutflow << SaveSystematic();
    }

    *cutflow << NewSystematic("shift in muon fraction determination"); {
        *cutflow << WeightSystematic(SupersysWeight::MUFRACUP, SupersysWeight::MUFRACDOWN);
        *cutflow << TreeName("MUFRAC");
        *cutflow << SaveSystematic();
    }
