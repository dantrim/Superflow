...
//MC Backgrounds + DATA
//
#define DIR_DATA "/gdata/atlas/dantrim/SusyAna/histoAna/run2early/n0206pup/Jul7_signal/data/Processed/"
#define DATA_FILE "data15_13TeV.root"

#define DIR_MC "/gdata/atlas/dantrim/SusyAna/histoAna/run2early/n0206pup/Jul7_signal/mc/Processed/"
#define MC_FILE "mc15_13TeV.root"

#define DIR_1 "/gdata/atlas/dantrim/SusyAna/userSusyNt/plots_Jul7cor/"
...
/*        /////////////
        ...
        plot_.root_get_member   = "l_d0[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "lead electron d0";
            plot_.signal_region = "z_like_e";
            plot_.long_name     = "z_like_e_leadd0";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.01;
            plot_.x_range_min   = -0.3;
            plot_.x_range_max   = 0.3;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 1000;
            vect_plot.push_back(plot_);

        plot_.root_get_member   = "l_d0[1]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "sub-lead electron d0";
            plot_.signal_region = "z_like_e";
            plot_.long_name     = "z_like_e_subd0";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.01;
            plot_.x_range_min   = -0.3;
            plot_.x_range_max   = 0.3;
        ...
        plot_.root_get_member   = "l_d0sig[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "lead electron d0sig";
            plot_.signal_region = "z_like_e";
            plot_.long_name     = "z_like_e_leadd0sig";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.5;
            plot_.x_range_min   = -10;
            plot_.x_range_max   = 10;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 1000;
            vect_plot.push_back(plot_);

        plot_.root_get_member   = "l_d0sig[1]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "sub-lead electron d0sig";
            plot_.signal_region = "z_like_e";
            plot_.long_name     = "z_like_e_subd0sig";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.5;
            plot_.x_range_min   = -6;
            plot_.x_range_max   = 6;
        ...
        plot_.root_get_member   = "l_d0sig[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "lead muon d0sig";
            plot_.signal_region = "z_like_m";
            plot_.long_name     = "z_like_m_leadd0sig";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.5;
            plot_.x_range_min   = -6;
            plot_.x_range_max   = 6;
        ...
        plot_.root_get_member   = "l_d0sig[1]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "sub-lead muon d0sig";
            plot_.signal_region = "z_like_m";
            plot_.long_name     = "z_like_m_subd0sig";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.5;
            plot_.x_range_min   = -6;
            plot_.x_range_max   = 6;
        ...
        plot_.root_get_member   = "l_d0[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "lead muon d0";
            plot_.signal_region = "z_like_m";
            plot_.long_name     = "z_like_m_leadd0";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.01;
            plot_.x_range_min   = -0.3;
            plot_.x_range_max   = 0.3;
        ...
        plot_.root_get_member   = "l_d0[1]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "sub-lead muon d0";
            plot_.signal_region = "z_like_m";
            plot_.long_name     = "z_like_m_subd0";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.01;
            plot_.x_range_min   = -0.3;
            plot_.x_range_max   = 0.3;
        ...
        plot_.root_get_member   = "pT_balance";
        plot_.root_get_factor   = "";
        plot_.x_label           = "p_{T}^{jet}/p_{T}^{Z}";
            plot_.signal_region = "preZbalance_e_jvt95";
            plot_.long_name     = "preZbalance_e_jvt95_pT_balance";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 3;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 160;
            vect_plot.push_back(plot_);

        plot_.root_get_member   = "abs(phi_balance)";
        plot_.root_get_factor   = "";
        plot_.x_label           = "|#Delta#phi(Z,lead-j)|";
            plot_.signal_region = "preZbalance_e_jvt95";
            plot_.long_name     = "preZbalance_e_jvt95_phi_balance";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 3.2;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 100;
            vect_plot.push_back(plot_);

        plot_.root_get_member   = "pT_balance";
        plot_.root_get_factor   = "";
        plot_.x_label           = "p_{T}^{jet}/p_{T}^{Z}";
            plot_.signal_region = "preZbalance_m_jvt95";
            plot_.long_name     = "preZbalance_m_jvt95_pT_balance";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 3;
        ...
        plot_.x_label           = "|#Delta#phi(Z,lead-j)|";
            plot_.signal_region = "preZbalance_m_jvt95";
            plot_.long_name     = "preZbalance_m_jvt95_phi_balance";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 3.2;
...
*/
        ...
        plot_.x_label           = "TST #slash{E}_{T} [GeV]";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_met";
            plot_.y_label       = "Events / 2 GeV";
            plot_.x_bin_width   = 2;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 50;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 40;
            vect_plot.push_back(plot_);

        plot_.root_get_member   = "metX";
        plot_.root_get_factor   = "";
        plot_.x_label           = "TST #slash{E}_{T}-x [GeV]";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_metX";
            plot_.y_label       = "Events / 4 GeV";
            plot_.x_bin_width   = 4;
            plot_.x_range_min   = -40;
            plot_.x_range_max   = 40;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 60;
            vect_plot.push_back(plot_);

        plot_.root_get_member   = "metY";
        plot_.root_get_factor   = "";
        plot_.x_label           = "TST #slash{E}_{T}-y [GeV]";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_metY";
            plot_.y_label       = "Events / 4 GeV";
            plot_.x_bin_width   = 4;
            plot_.x_range_min   = -40;
            plot_.x_range_max   = 40;
        ...
        plot_.x_label           = "m_{ee} [GeV]";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_mll";
            plot_.y_label       = "Events / 2 GeV";
            plot_.x_bin_width   = 2;
            plot_.x_range_min   = 70;
            plot_.x_range_max   = 110;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 70;
            vect_plot.push_back(plot_);

        plot_.root_get_member   = "pTll";
        plot_.root_get_factor   = "";
        plot_.x_label           = "p_{T}^{Z} [GeV]";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_pTll";
            plot_.y_label       = "Events / 5 GeV";
            plot_.x_bin_width   = 5;
            plot_.x_range_min   = 20;
            plot_.x_range_max   = 150;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 45;
            vect_plot.push_back(plot_);
        ...
        plot_.x_label           = "p_{T}^{jet}/p_{T}^{Z}";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_pT_balance";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 3;
        ...
        plot_.x_label           = "|#Delta#phi(Z,lead-j)|";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_phi_balance";
            plot_.y_label       = "Events";
            plot_.x_bin_width   = 0.1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 3.2;
        ...
        plot_.root_get_member   = "j_pt[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "Lead jet p_{T} [GeV]";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_j0pt";
            plot_.y_label       = "Events / 5 GeV";
            plot_.x_bin_width   = 5;
            plot_.x_range_min   = 25;
            plot_.x_range_max   = 150;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 50;
            vect_plot.push_back(plot_);

        plot_.is_Log = true;
        plot_.root_get_member   = "j_jvt[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "Lead jet JVT";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_j0jvt";
            plot_.y_label       = "Events / 0.02";
            plot_.x_bin_width   = 0.02;
            plot_.x_range_min   = -0.2;
            plot_.x_range_max   = 1.1;
            plot_.y_range_min   = 1.0e-1;
            plot_.y_range_max   = 1.0e3;
            vect_plot.push_back(plot_);
        plot_.is_Log = false;

        plot_.root_get_member   = "j_jvf[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "Lead jet JVF";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_j0jvf";
            plot_.y_label       = "Events / 0.05";
        ...
        plot_.root_get_member   = "j_nTracks[0]";
        plot_.root_get_factor   = "";
        plot_.x_label           = "No. of tracks in lead jet";
            plot_.signal_region = "Zbalance_e_jvt95";
            plot_.long_name     = "Zbalance_e_jvt95_j0nTracks";
            plot_.y_label       = "Events / trk";
            plot_.x_bin_width   = 1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 20;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 100;
            vect_plot.push_back(plot_);
        ...
        plot_.root_get_factor   = "";
        plot_.x_label           = "TST #slash{E}_{T} [GeV]";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_met";
            plot_.y_label       = "Events / 3 GeV";
            plot_.x_bin_width   = 3;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 60;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 40;
            vect_plot.push_back(plot_);
        ...
        plot_.x_label           = "TST #slash{E}_{T}-x [GeV]";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_metX";
            plot_.y_label       = "Events / 4 GeV";
            plot_.x_bin_width   = 4;
            plot_.x_range_min   = -40;
            plot_.x_range_max   = 40;
        ...
        plot_.x_label           = "TST #slash{E}_{T}-y [GeV]";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_metY";
            plot_.y_label       = "Events / 4 GeV";
            plot_.x_bin_width   = 4;
            plot_.x_range_min   = -40;
            plot_.x_range_max   = 40;
        ...
        plot_.x_label           = "m_{#mu#mu} [GeV]";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_mll";
            plot_.y_label       = "Events / 2 GeV";
            plot_.x_bin_width   = 2;
            plot_.x_range_min   = 70;
            plot_.x_range_max   = 110;
        ...
        plot_.x_label           = "p_{T}^{Z} [GeV]";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_pTll";
            plot_.y_label       = "Events / 5 GeV";
            plot_.x_bin_width   = 5;
            plot_.x_range_min   = 20;
            plot_.x_range_max   = 140;
            plot_.y_range_min   = 0.0;
            plot_.y_range_max   = 50;
            vect_plot.push_back(plot_);
        ...
        plot_.x_label           = "Lead jet p_{T} [GeV]";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_j0pt";
            plot_.y_label       = "Events / 5 GeV";
            plot_.x_bin_width   = 5;
            plot_.x_range_min   = 25;
            plot_.x_range_max   = 150;
        ...
        plot_.x_label           = "Lead jet JVT";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_j0jvt";
            plot_.y_label       = "Events / 0.02";
            plot_.x_bin_width   = 0.02;
            plot_.x_range_min   = -0.2;
            plot_.x_range_max   = 1.1;
            plot_.y_range_min   = 1.0e-2;
            plot_.y_range_max   = 1.0e3;
            vect_plot.push_back(plot_);
        ...
        plot_.x_label           = "Lead jet JVF";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_j0jvf";
            plot_.y_label       = "Events / 0.05";
            plot_.x_bin_width   = 0.05;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 1.1;
        ...
        plot_.x_label           = "No. of tracks in lead jet";
            plot_.signal_region = "Zbalance_m_jvt95";
            plot_.long_name     = "Zbalance_m_jvt95_j0nTracks";
            plot_.y_label       = "Events / trk";
            plot_.x_bin_width   = 1;
            plot_.x_range_min   = 0;
            plot_.x_range_max   = 20;
...
int main(int argc, char* argv[])
{
    ...
    // ---------------------------------------------- //
    tcuts_join << "nLeptons==2 && nElectrons==2 && l_pt[0]>25 && l_pt[1]>25";
    tcuts["z_like_e"] = tcuts_join.str(); tcuts_join.str("");

    tcuts_join << "nLeptons==2 && nMuons==2 && l_pt[0]>25 && l_pt[1]>25";
    tcuts["z_like_m"] = tcuts_join.str(); tcuts_join.str("");

    tcuts_join << "nLeptons==2 && nElectrons==2 && l_pt[0]>25 && l_pt[1]>25 && nJets==1 && nBJets==0";
    tcuts["preZbalance_e_jvt95"] = tcuts_join.str(); tcuts_join.str(""); 

    tcuts_join << "nLeptons==2 && nMuons==2 && l_pt[0]>25 && l_pt[1]>25 && nJets==1 && nBJets==0";
    tcuts["preZbalance_e_jvt95"] = tcuts_join.str(); tcuts_join.str(""); 

    tcuts_join << "nLeptons==2 && nElectrons==2 && l_pt[0]>25 && l_pt[1]>25 && nJets==1 && nBJets==0 && abs(1-pT_balance)<0.22 && abs(phi_balance)>2.5 && j_jvt[0]>0.95";
    tcuts["Zbalance_e_jvt95"] = tcuts_join.str(); tcuts_join.str("");

    tcuts_join << "nLeptons==2 && nMuons==2 && l_pt[0]>25 && l_pt[1]>25 && nJets==1 && nBJets==0 && abs(1-pT_balance)<0.22 && abs(phi_balance)>2.5 && j_jvt[0]>0.95";
    tcuts["Zbalance_m_jvt95"] = tcuts_join.str(); tcuts_join.str("");
    ...
    for (int r_ = 0; r_ < request_plots.size(); r_++) {
        ...
        // if we are telling root to take absolute value of the leaf, remove it from the histogram
        // name since TTraw will go ape shit on you otherwise!
        size_t find = plot_.root_get_member.find("abs(");
        string correction = "";
        if(find!=string::npos) {
            correction = plot_.root_get_member.substr(4, plot_.root_get_member.length()-5);
        }
        for (int t_ = 0; t_ < hft_trees.size(); t_++) {
            stringstream hist_;
            if (plot_.root_get_member_name.compare("") == 0) {
                if(find!=string::npos){
                    hist_ << "h_" << plot_.signal_region << "_" << correction << "_" << hft_trees[t_].treename;
                }
                else {
...
//        tl_2->AddEntry(asym_errors, "Bkg. Uncert.", "f");
      ...
      //  myText(0.14, 0.74, kBlack, annoyingLabel2);
        ...
        string str = plot_.signal_region;
        const char * y = str.c_str();
        myText(0.18, 0.73, kBlack, y);
